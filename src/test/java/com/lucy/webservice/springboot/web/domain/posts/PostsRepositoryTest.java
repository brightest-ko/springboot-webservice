package com.lucy.webservice.springboot.web.domain.posts;
...
@SpringBootTest
//다른 설정 없으면 H2 데이터베이스를 자동으로 실행해준다.
...
//    여러 테스트가 동시에 수행되면 테스트용 데이터베이스인 H2에 데이터가 그대로 남아 있어 다음 테스트 실행 시 테스트가 실패할 수 있다.
    ...
    public void 게시글저장_불러오기(){
        ...
        postsRepository.save(Posts.builder()
                .title(title)
                .content(content)
                .author("brightest95hj@gmail.com")
                .build());
...
//        테이블 posts에 있는 모든 데이터를 조회해오는 메소드
        ...
        assertThat(posts.getAuthor()).isEqualTo("brightest95hj@gmail.com");
    }
